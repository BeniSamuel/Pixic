...
const PhotoDescriptionLeft:React.FC = () => {
  ...
  return (
    <div className=' bg-[#0E0E0E] h-[100vh] w-[100%] md:w-[70%] flex flex-col items-center gap-16 justify-center md:py-20 overflow-y-auto'>
        ...
        <div className=' flex flex-col gap-9 items-center'>
            ...
            <textarea typeof='text' placeholder='Provide a Description...'  className=' outline-none bg-transparent font-poppins text-white placeholder:font-poppins bg-[#1B1A1A] border-[#505050] border-2 rounded-lg pl-7 pt-6 w-[30rem] h-60'/>
        </div>
